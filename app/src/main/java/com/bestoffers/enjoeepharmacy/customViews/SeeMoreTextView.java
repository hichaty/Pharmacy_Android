...
import com.bestoffers.enjoeepharmacy.helperInterfaces.OnTextClicked;


/**
 * Created by Mukesh on 20/11/21.
 */
public class SeeMoreTextView extends AppCompatTextView {

    private Integer textMaxLength = 90;
    private Integer seeMoreTextColor = R.color.pink;
    ...
    private String seeMore = "Read More", seeLess = "Read Less";
